...
<body>
	...
	<div class="container">
		<div class="row" style="text-align: center;">
			<h1 class="page-header" style="margin-top:8vh; margin-bottom:4vh; padding-left: 1vw;">Science</h1>
		</div>
		<div class="row">
			<div class="col-sm-4 col-md-4" style="height: 350px;">
				<div class="jumbotron" style="padding-right: 10px;padding-left: 10px;">
					<p>A fun way for children to practice their general science knowledge.
					</p>
				</div>
			</div>
			<div class="col-sm-8 col-md-8 mtm">
				<img width="100%" src="images/sciencegame1inside.png" />
				<p style="position: absolute;left: 45%;top: 45%;"><a href="./sciencegame1/index.php" target="_blank" class="btn btn-primary" role="button">play</a></p>
			</div>
		</div>
		...
		<div class="row" style="margin-top: 15px;height: 350px;">
			<div class="bs-example" data-example-id="thumbnails-with-custom-content">
				<div class="row">
					...
					<div class="col-sm-6 col-md-3">
					<div class="thumbnail">
						<img data-src="holder.js/100%x200" alt="100%x200" src="images/mathgame2.png" data-holder-rendered="true" style="height: 250px; width: 100%; display: block;">
						<div class="caption">
						<a href="./mathgame2holder.php"><h3>Multiply</h3></a>
						</div>
					</div>
					</div>
					<div class="col-sm-6 col-md-3">
					...
					<div class="thumbnail">
						...
						<div class="caption">
						<a href="./englishgame1holder.php"><h3>English</h3></a>
						</div>
					</div>
					</div>
				</div>
