...
<body>
	...
	<div class="container">
		<div class="row" style="text-align: center;">
			<h1 class="page-header" style="margin-top:8vh; margin-bottom:4vh; padding-left: 1vw;">Arithmetic</h1>
		</div>
		<div class="row">
			<div class="col-sm-4 col-md-4" style="height: 350px;">
				<div class="jumbotron" style="padding-right: 10px;padding-left: 10px;">
					<p>A fun way for children to practice their arithmetic.
					</p>
				</div>
			</div>
			<div class="col-sm-8 col-md-8 mtm">
				<img width="100%" src="images/mathgame3inside.png" />
				<p style="position: absolute;left: 45%;top: 45%;"><a href="./mathgame3/index.php" target="_blank" class="btn btn-primary" role="button">play</a></p>
			</div>
		</div>
